...
const {decode_body, write_http_reply, url2domain,
    user_agent} = require('./util.js');
...
E.default = Object.assign({}, lpm_config.luminati_default);
E.dropin = {
...
E.prototype.route_req = etask._fn(function*route_req(_this, req, res, head){
    try {
        ...
        if (_this.opt.session_termination && (ctx.session||{}).terminated)
