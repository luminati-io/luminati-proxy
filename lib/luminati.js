...
Sess_mgr.prototype.request_session = function(req){
    ...
    const authorization = this.opt.allow_proxy_auth &&
...
E.prototype._send_rule_mail = function(to, trigger, action, url){
    return this.mgr.send_rule_mail(this.port, to, trigger, action, url);
};
...
E.prototype._aggregate_history = function(response){
    ...
    .find(i=>i)||['', '', ''];
    // XXX krzysztof: make use of it or remove from the code
    const node_latency = +((headers['x-hola-timeline-debug']||'')
