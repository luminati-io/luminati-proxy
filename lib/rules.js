...
class Rules {
    ...
    check_req_time_range(req, rule){
        ...
        {
            this.server.session_mgr.remove_session_from_pool(
    ...
    action(req, res, head, rule, opt){
        ...
        {
            this.server.session_mgr.add_reserve_pool_session(req.ctx.session,
                rule.pool_key);
            this.server.session_mgr.add_to_pool(req.ctx.session);
        }
        if (rule.action.fast_pool_session)
        {
            this.server.session_mgr.add_fast_pool_session(req.ctx.session,
