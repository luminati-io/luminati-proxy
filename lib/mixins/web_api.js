...
function*add_www_whitelist_ip_api(_this, req, res, next){
    ...
    if (_this._defaults.www_whitelist_ips.includes(ip))
        return res.send('OK');
    const new_ips = _this._defaults.www_whitelist_ips.concat([ip]);
...
function*add_wip_api(_this, req, res, next){
    ...
    if (_this._defaults.whitelist_ips.includes(ip))
        return res.send('OK');
    _this.set_whitelist_ips(_this._defaults.whitelist_ips.concat([ip]));
