...
const carriers_json = path.resolve(__dirname, '../db/carriers.json');
...
let carrier2asn = {};
try { carrier2asn = JSON.parse(fs.readFileSync(carriers_json)); }
catch(e){ console.log(e); }

const asn2carrier = {};
for (let carrier in carrier2asn)
{
    for (let asn of carrier2asn[carrier])
    {
