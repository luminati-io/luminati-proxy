...
E.prototype.gen_token_api = function(req, res){
    ...
    this._defaults.token_md5 = crypto.createHash('md5')
...
E.prototype.add_wip_api = etask._fn(function*(_this, req, res){
    const token_md5 = _this._defaults.token_md5;
    const auth_token = crypto.createHash('md5')
        .update(req.headers.authorization).digest('hex');
    if (!token_md5 || token_md5!=auth_token)
