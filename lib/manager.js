...
Manager.prototype.config_get = function(req, res){
    res.json({config: file.read_e(this.argv.config)});
};
...
function*creds_set(_this, req, res){
    ...
    {
        _.values(_this.proxies_running).forEach(proxy=>{
            proxy.update_creds(_this.argv.customer, _this.argv.password);
        });
    }
...
Manager.prototype.init_proxies = etask._fn(function*init_proxies(_this){
    ...
    {
        proxies.push(_this.create_proxy({port: 22225, sticky_ip: true,
