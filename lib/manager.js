...
E.prototype.trace_api = etask._fn(function*mgr_trace(_this, req, res){
    ...
    const result = yield tracer.trace(opt.url, opt.port, _this.opts.log);
    res.json(result);
});
...
E.prototype.create_api_interface = function(){
    ...
    app.post('/trace', this._api(this.trace_api));
