...
const rate_limit = require('./rate_limit.js');
...
E.prototype.check_deprecated_mw = function(req, res, next){
    const swagger_ep = util_lib.swagger_util.get_ep(req);
    if (swagger_ep && swagger_ep.deprecated)
...
E.prototype.create_api = function(){
    ...
    app.use(rate_limit.default);
    app.use(this.authenticate_mw.bind(this));
    app.use(this.check_deprecated_mw.bind(this));
