...
function Manager(argv, run_config={}){
    ...
    try {
        ...
        this.opts = Object.assign(zutil.pick(argv,
            ...
            zutil.pick(conf._defaults, 'debug'));
...
function*(_this, port, new_proxy, opt={}){
    ...
    if (old_opt.debug && old_opt.debug.startsWith('default'))
    {
        delete old_opt.debug;
        new_proxy.debug = new_proxy.debug.split('-')[1];
    }
...
E.prototype.update_ports = function(opt){
    ...
    Object.values(this.proxy_ports).forEach(p=>{
        ...
        const override = {};
        if (opt.debug!==undefined && conf.debug!==undefined &&
            conf.debug!=opt.debug)
        {
            override.debug = conf.debug;
        }
