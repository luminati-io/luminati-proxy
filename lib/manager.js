...
E.prototype.creds_user_api = etask._fn(function*mgr_creds(_this, req, res){
    // XXX krzysztof: if logged in then return error
...
E.prototype.create_api_interface = function(){
    ...
    app.post('/add_lpm_wip', this._api(this.add_lpm_wip_api));
    return app;
};
...
E.prototype.create_server = function(app){
    if (this.argv.zagent)
    {
        ...
        try {
            ...
            logger.warn('This zagent could not find SSL certificates: %s',
                e.message);
        }
    }
...
E.prototype.lpm_f_ws_login =
etask._fn(function*mgr_lpm_f_ws_login(_this, opt, cb){
