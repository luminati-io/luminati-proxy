...
Manager.prototype.create_api_interface = function(){
    ...
    app.get('/proxies', this._api((req, res)=>{
        let r = _.values(this.proxies)
            .sort((a, b)=>a.port-b.port); // TODO Lee: the sorting should be in UI
        res.json(r);
    }));
    ...
    app.post('/delete', this._api(this.proxies_delete_api)); // XXX HERE
