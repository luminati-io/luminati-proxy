...
E.prototype.get_notifs = etask._fn(function*get_notifs(_this, req, res){
    const lum_conf = yield _this.get_lum_local_conf();
    res.json(lum_conf.lpm_notifs||[]);
});

E.prototype.update_notif = etask._fn(function*update_notif(_this, req, res){
