...
const E = [
    ...
    {name: 'Chrome 84 Android 8', value: 'Mozilla/5.0 (Linux; Android 8.1.0; '
        ...
        +'Version/4.0 Chrome/84.0.4147.125 Mobile Safari/537.36'},
    ...
    {name: 'Chrome 84 Linux', value: 'Mozilla/5.0 (X11; Linux x86_64) '
        ...
        +'Safari/537.36'},
    {name: 'Chrome 84 iOS 12.1', value: 'Mozilla/5.0 (iPhone; CPU iPhone OS '
        +'12_1 like Mac OS X) AppleWebKit/605.115 (KHTML, like Gecko) '
        +'CriOS/84.0.4147.122 Mobile/15E148 Safari/605.1'},
    {name: 'Chrome 84 Samsung Galaxy S6', value: 'Mozilla/5.0 (Linux; Android '
        ...
        +'Gecko) Chrome/84.0.4147.125 Mobile Safari/537.36'},
    ...
    {name: 'Firefox 79 Windows 10', value: 'Mozilla/5.0 (Windows NT 10.0; '
        +'Win64; x64; rv:63.0) Gecko/20100101 Firefox/79.0'},
    {name: 'Firefox 79 Windows 7', value: 'Mozilla/5.0 (Windows NT 6.1; '
        +'WOW64; rv:53.0) Gecko/20100101 Firefox/79.0'},
    {name: 'Firefox 79 OSX 10.14.1', value: 'Mozilla/5.0 (Macintosh; Intel '
        +'Mac OS X 10.14.1; rv:63.0) Gecko/20100101 Firefox/79.0'},
    {name: 'Firefox 79 Linux', value: 'Mozilla/5.0 (X11; Ubuntu; '
        +'Linux x86_64; rv:53.0) Gecko/20100101 Firefox/79.0'},
    ...
    {name: 'Firefox 79 Android 8', value: 'Mozilla/5.0 (Android 8.1.0; '
        +'Mobile; rv:61.0) Gecko/41.0 Firefox/79.0.5'},
    ...
    {name: 'Safari Mobile 12.1 iOS 12', value: 'Mozilla/5.0 (iPhone; CPU '
        ...
        +'Gecko) Version/12.1.2 Mobile/15E148 Safari/12.1.2'},
    ...
    {name: 'Edge 84 Windows 10', value: 'Mozilla/5.0 (Windows NT 10.0; Win64; '
        +'x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.125 '
        +'Safari/537.36 Edge/84.0.522.61'},
