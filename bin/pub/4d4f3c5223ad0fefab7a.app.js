...
Proxies.$inject = ['$scope', '$http', '$proxies', '$window', '$q', '$timeout', '$stateParams', '$success_rate'];
function Proxies($scope, $http, $proxies, $window, $q, $timeout, $stateParams, $success_rate) {
