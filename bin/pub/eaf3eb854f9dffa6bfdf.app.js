    ...
    $scope.init = function (locals) {
        ...
        $scope.$watchCollection('form', function (newv, oldv) {
            ...
            for (var f in oldv) {
                ...
                val = newv[f] || '';
                if (old !== val) {
                    ga_event('proxy_form', f + '_change', f == 'password' ? 'redacted' : val);
                }
            }
        });
            ...
            if (Object.keys(proxy.rules || {}).length) {
                ...
                proxy.rules = {
                    post: {
                        res: {
                            head: true,
                            status: Object.assign({ type: 'in' }, proxy_post.res.status),
                ...
                if (!proxy.rules.post.url) delete proxy.rules.post.url;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            this.state.stats.map(function (s, i) {
                                ...
                                var local = new Date(rh.date).toLocaleString();
                                return _react2.default.createElement(
                                    'tr',
                                    { key: i },
                                    _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(_reactBootstrap.Pagination, { prev: true, next: true, boundaryLinks: true,
