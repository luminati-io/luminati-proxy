...
_module.controller('root', ['$rootScope', '$scope', '$http', '$window', '$state', '$transitions', function ($rootScope, $scope, $http, $window, $state, $transitions) {
    ...
    $scope.quickstart = function () {
        ...
        if (typeof hq == 'undefined') return false;
    ...
    $scope.quickstart_navigate = function (to) {
        switch (to) {
            case 'create_proxy':
                if (!$window.localStorage.getItem('quickstart-creds')) return '';
                return $state.go('proxies', { add_proxy: true });
            case 'test_proxy':
                if (!$window.localStorage.getItem('quickstart-create-proxy')) return;
                return $state.go('tools');
            case 'stats':
                if (!$window.localStorage.getItem('quickstart-test-proxy')) return;
...
Proxies.$inject = ['$scope', '$http', '$proxies', '$window', '$q', '$timeout', '$stateParams'];
function Proxies($scope, $http, $proxies, $window, $q, $timeout, $stateParams) {
    ...
    if ($stateParams.add_proxy) $scope.add_proxy();
}
...
var SuccessRatio = function (_React$Component3) {
    ...
    function SuccessRatio() {
        ...
        return _possibleConstructorReturn(this, (SuccessRatio.__proto__ || Object.getPrototypeOf(SuccessRatio)).apply(this, arguments));
    }
    ...
    _createClass(SuccessRatio, [{
        ...
        value: function render() {
            var overallSuccessTooltip = _react2.default.createElement(
                ...
                {
                    id: 'succes-tooltip' },
                'Successful requests out of total requests'
            );
            return _react2.default.createElement(
                _reactBootstrap.Row,
                { className: 'hidden overall-success-ratio ' },
                _react2.default.createElement(
...
var Stats = function (_React$Component4) {
    ...
    function Stats(props) {
        ...
        _this9.get_stats = _etask2.default._fn( /*#__PURE__*/_regeneratorRuntime2.default.mark(function _callee2(_this) {
...
// is here
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(558), __webpack_require__(262), __webpack_require__(559)], __WEBPACK_AMD_DEFINE_RESULT__ = function(events, array, zutil){
var E = Etask;
var etask = Etask;
