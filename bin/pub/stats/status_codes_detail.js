...
define(['regenerator-runtime', 'lodash', 'react', 'react-dom', 'react-bootstrap', 'hutil/etask', '/stats/common.js', '/stats/status_codes.js', '/stats/domains.js', '/stats/protocols.js'], function (rr, _, React, ReactDOM, RB, etask, Common, StatusCode, Domain, Protocol) {
    ...
    var E = {
        install: function install(mnt, _ref) {
            ...
            ReactDOM.render(React.createElement(StatsDetails, { code: code }), mount = mnt);
        },
                        ...
                        while (1) {
                            switch (_context.prev = _context.next) {
                                case 0:
                                    _context.t0 = _this;
                                    _context.next = 3;
                                    return Common.StatsService.get(_this.props.code);
            ...
            value: function render() {
                ...
                return React.createElement(
                    ...
                    { stats: this.state.stats,
                        header: 'Status code: ' + this.props.code, title: React.createElement(
                            Col,
                            { md: 12 },
                            React.createElement(
                                Col,
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(
                                        'span',
                                        null,
                                        'Definition of status code ' + this.props.code + ':\n                        ' + (StatusCode.status_codes[this.props.code] || this.props.code)
                                    )
                                )
                            )
                        ) },
                    React.createElement(
                        ...
                        React.createElement(Domain.Table, { stats: this.state.domains.stats })
                    ),
                    React.createElement(
                        Col,
                        { md: 6 },
