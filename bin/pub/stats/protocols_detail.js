...
define(['regenerator-runtime', 'lodash', 'react', 'react-dom', 'react-bootstrap', 'hutil/etask', '/stats/common.js', '/stats/status_codes.js', '/stats/domains.js'], function (rr, _, React, ReactDOM, RB, etask, Common, StatusCode, Domain) {
    ...
    var E = {
        install: function install(mnt, _ref) {
            ...
            E.sp = etask('protocol_detail', [function () {
                return this.wait();
            }]);
            ReactDOM.render(React.createElement(StatsDetails, { protocol: protocol }), mount = mnt);
        },
                        ...
                        while (1) {
                            switch (_context.prev = _context.next) {
                                case 0:
                                    _context.t0 = _this;
                                    _context.next = 3;
                                    return Common.StatsService.get(_this.props.protocol);
