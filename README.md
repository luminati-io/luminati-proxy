...
### Windows
Download the <a href="https://github.com/luminati-io/luminati-proxy/releases/download/v1.61.493/luminati-proxy-manager-v1.61.493-setup.exe">Luminati Proxy Manager installer</a>.
