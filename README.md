...
### Windows
Download the <a href="https://github.com/luminati-io/luminati-proxy/releases/download/v1.63.154/luminati-proxy-manager-v1.63.154-setup.exe">Luminati Proxy Manager installer</a>.
