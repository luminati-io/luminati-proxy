...
### Windows
Download the <a href="https://github.com/luminati-io/luminati-proxy/releases/download/v1.69.931/luminati-proxy-manager-v1.69.931-setup.exe">Luminati Proxy Manager installer</a>.
