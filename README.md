...
### Windows
Download the <a href="https://github.com/luminati-io/luminati-proxy/releases/download/v1.64.509/luminati-proxy-manager-v1.64.509-setup.exe">Luminati Proxy Manager installer</a>.
