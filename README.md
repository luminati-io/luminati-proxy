...
### Windows
Download the <a href="https://github.com/luminati-io/luminati-proxy/releases/download/v1.65.923/luminati-proxy-manager-v1.65.923-setup.exe">Luminati Proxy Manager installer</a>.
