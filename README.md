...
### Windows
Download the [Proxy Manager installer](https://github.com/luminati-io/luminati-proxy/releases/download/v1.228.97/luminati-proxy-manager-v1.228.97-setup.exe)
