...
### Windows
Download the <a href="https://github.com/luminati-io/luminati-proxy/releases/download/v1.56.937/luminati-proxy-manager-v1.56.937-setup.exe">Luminati Proxy Manager installer</a>.
