...
### Windows
Download the [Proxy Manager installer](https://github.com/luminati-io/luminati-proxy/releases/download/v1.283.18/luminati-proxy-manager-v1.283.18-setup.exe)
