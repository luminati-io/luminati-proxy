...
### Windows
Download the <a href="https://github.com/luminati-io/luminati-proxy/releases/download/v1.75.912/luminati-proxy-manager-v1.75.912-setup.exe">Luminati Proxy Manager installer</a>.
