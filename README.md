...
### Windows
Download the <a href="https://github.com/luminati-io/luminati-proxy/releases/download/v1.76.363/luminati-proxy-manager-v1.76.363-setup.exe">Luminati Proxy Manager installer</a>.
