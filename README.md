...
### Windows
Download the [Luminati Proxy Manager installer](https://github.com/luminati-io/luminati-proxy/releases/download/v1.86.25/luminati-proxy-manager-v1.86.25-setup.exe)
...
- docker inspect lpm-vol
  ...
  Take the mountpoint path /var/lib/docker/volumes/lpmvol/_data
