...
### Windows
Download the [Proxy Manager installer](https://github.com/luminati-io/luminati-proxy/releases/download/v1.300.88/luminati-proxy-manager-v1.300.88-setup.exe)
