...
### Windows
Download the <a href="https://github.com/luminati-io/luminati-proxy/releases/download/v1.72.569/luminati-proxy-manager-v1.72.569-setup.exe">Luminati Proxy Manager installer</a>.
