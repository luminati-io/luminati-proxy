...
### Windows
Download the <a href="https://github.com/luminati-io/luminati-proxy/releases/download/v1.72.187/luminati-proxy-manager-v1.72.187-setup.exe">Luminati Proxy Manager installer</a>.
