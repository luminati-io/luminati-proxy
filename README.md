...
### Windows
Download the <a href="https://github.com/luminati-io/luminati-proxy/releases/download/v1.57.189/luminati-proxy-manager-v1.57.189-setup.exe">Luminati Proxy Manager installer</a>.
