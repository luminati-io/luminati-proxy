...
### Windows
Download the <a href="https://github.com/luminati-io/luminati-proxy/releases/download/v1.61.772/luminati-proxy-manager-v1.61.772-setup.exe">Luminati Proxy Manager installer</a>.
