...
### Windows
Download the [Proxy Manager installer](https://github.com/luminati-io/luminati-proxy/releases/download/v1.293.49/luminati-proxy-manager-v1.293.49-setup.exe)
