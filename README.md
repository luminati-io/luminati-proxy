...
### Windows
Download the <a href="https://github.com/luminati-io/luminati-proxy/releases/download/v1.64.275/luminati-proxy-manager-v1.64.275-setup.exe">Luminati Proxy Manager installer</a>.
