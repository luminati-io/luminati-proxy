...
### Windows
Download the <a href="https://github.com/luminati-io/luminati-proxy/releases/download/v1.75.355/luminati-proxy-manager-v1.75.355-setup.exe">Luminati Proxy Manager installer</a>.
