...
### Windows
Download the <a href="https://github.com/luminati-io/luminati-proxy/releases/download/v1.68.476/luminati-proxy-manager-v1.68.476-setup.exe">Luminati Proxy Manager installer</a>.
