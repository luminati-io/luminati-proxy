...
### Windows
Download the <a href="https://github.com/luminati-io/luminati-proxy/releases/download/v1.55.669/luminati-proxy-manager-1.55.669-setup.exe">Luminati Proxy Manager installer</a>.
