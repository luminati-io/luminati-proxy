...
### Windows
Download the <a href="https://github.com/luminati-io/luminati-proxy/releases/download/v1.59.973/luminati-proxy-manager-v1.59.973-setup.exe">Luminati Proxy Manager installer</a>.
