...
### Windows
Download the [Luminati Proxy Manager installer](https://github.com/luminati-io/luminati-proxy/releases/download/v1.86.704/luminati-proxy-manager-v1.86.704-setup.exe)
