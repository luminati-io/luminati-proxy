...
### Windows
Download the <a href="https://github.com/luminati-io/luminati-proxy/releases/download/v1.70.323/luminati-proxy-manager-v1.70.323-setup.exe">Luminati Proxy Manager installer</a>.
